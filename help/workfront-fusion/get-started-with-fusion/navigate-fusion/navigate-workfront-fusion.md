...
| Webhook <br> ![Webhook 图标](assets/webhooks-icon.png) | Webhooks 会监控应用程序中的变化，并根据该变化启动场景。例如，您可以配置一个 Webhook，在向某个 Workfront 项目提交问题时启动对应场景。在 Webhook 区域，您可以查看团队配置的 Webhook 列表，以及它们所关联的场景。 | [即时触发器 (Webhook)](/help/workfront-fusion/references/modules/webhooks-reference.md) |
