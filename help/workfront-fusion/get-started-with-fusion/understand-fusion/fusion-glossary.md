...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr>
   ...
   <td> <p>连接表示一组用于连接到给定服务的凭据。 您可以在任意模块中配置连接，并在其他模块中复用该连接。每个模块都必须选择一个连接，以便 Fusion 使用这些凭据访问该模块所需的信息。 </p><p>有关更多信息，请参阅<a href="/help/workfront-fusion/get-started-with-fusion/understand-fusion/connection-overview.md" class="MCXref xref">连接概述</a>。</p> </td> 
  </tr> 
  <tr> 
