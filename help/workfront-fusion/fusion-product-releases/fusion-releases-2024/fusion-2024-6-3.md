...
ht-degree: 12%
---
# Workfront Fusion 发行活动：2024 年 6 月 3 日当周
...
对于不通过Workfront Experience Cloud访问Fusion的用户，更新了Adobe Fusion。 新的Fusion UI提供了与其他Adobe产品更加无缝的体验，并将使您的用户顺利过渡到Adobe Experience Cloud。

以前，通过Adobe Experience Cloud访问Fusion的用户和未访问的用户体验会有很大差异。
