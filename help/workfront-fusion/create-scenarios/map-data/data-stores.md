...
您组织中的每个团队最多可以拥有50个数据存储。 这些数据存储的组合大小不能超过贵组织的数据存储总大小。
...
1. 创建或编辑数据存储时，单击“数据结构”字段旁边的&#x200B;**[!UICONTROL 添加]**。
...
1. 单击要编辑的数据存储旁边的复选框，然后单击屏幕底部横幅中的&#x200B;**编辑**。
...
1. 单击要编辑的数据存储旁边的复选框，然后单击屏幕底部横幅中的&#x200B;**浏览**。
1. （可选）通过单击&#x200B;**[!UICONTROL 添加]**，然后输入新项的信息来向数据存储添加新项。
1. （可选）从数据存储中删除一个或多个项目，方法是单击该项目的复选框，然后单击屏幕右上角的&#x200B;**删除选定的**&#x200B;或&#x200B;**删除所有**。
1. 单击&#x200B;**[!UICONTROL 保存]**。
