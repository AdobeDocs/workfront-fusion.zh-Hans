...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>[！UICONTROL记录类型] </td> 
   <td> <p>选择记录类型，其中包含您希望模块监视的字段。 您必须选择在[!DNL Salesforce]设置中启用了[！UICONTROL字段历史记录]的记录类型。 有关详细信息，请参阅<a href="https://help.salesforce.com/s/articleView?id=xcloud.tracking_field_history.htm&amp;type=5">文档中的</a>字段历史记录跟踪[!DNL Salesforce]。 </p> </td> 
  </tr> 
  <tr> 
   <td>[！UICONTROL字段]</td> 
