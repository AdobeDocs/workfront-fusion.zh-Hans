...
* [在Fusion中配置Oauth2连接](#configure-the-oauth2-connection-in-fusion)
...
1. 在&#x200B;**回调URL**&#x200B;字段中，根据您的Workfront Fusion数据中心，输入以下URL之一：
   ...
   | 融合数据中心 | 回调 URL |
   |---|---|
   | 美国 | `https://app.workfrontfusion.com/oauth/cb/workfront-jira2` |
...
* 重定向URL
  ...
  | 融合数据中心 | 重定向 URL |
  |---|---|
  | 美国 | `https://app.workfrontfusion.com/oauth/cb/workfront-jira` |
