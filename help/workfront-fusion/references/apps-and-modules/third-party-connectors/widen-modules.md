...
## 将[!DNL Widen]连接到Workfront Fusion  {#connect-widen-to-workfront-fusion}
...
在配置[!DNL Widen]模块时，Workfront Fusion将显示以下列出的字段。 除此以外，可能还会显示其他[!DNL Widen]字段，具体取决于应用程序或服务中的访问级别等因素。 模块中的粗体标题表示必填字段。
