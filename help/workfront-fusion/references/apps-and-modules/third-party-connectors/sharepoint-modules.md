...
1. 填写以下字段：
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      <td role="rowheader"> <p>[!UICONTROL 连接类型]</p> </td> 
     ...
     <tr> 
      <td role="rowheader"> <p>[!UICONTROL 客户端 ID]</p> </td> 
...
此模块会返回并在SharePoint中创建文件。 此模块的性能优于创建文件（旧版）模块。
...
为了提高性能，我们建议使用[创建文件](#create-a-file)模块。
