---
title: Split.io 模块
description: 在 Adobe Workfront Fusion 场景中，您可以自动化使用  [!DNL Split.io] 的工作流，并将其连接到多个第三方应用程序和服务。
author: Becky
...
在 Adobe Workfront Fusion 场景中，您可以自动化使用 [!DNL Split.io] 的工作流，并将其连接到多个第三方应用程序和服务。
...
要使用 [!DNL Split.io] 模块，您必须拥有一个 [!DNL Split.io] 帐户。
...
## 将 [!DNL Split.io] 连接到 Workfront Fusion  {#connect-split-io-to-workfront-fusion}
...
在您配置 [!DNL split.io] 模块时，Workfront Fusion 会显示以下字段。 除这些字段外，根据您的应用程序或服务访问权限级别，可能会显示更多 [!DNL split.io] 字段。 模块中的加粗标题表示必填字段。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>对于要添加到定义的每个定位规则，单击<b>[！UICONTROL添加项]</b>，然后输入或映射该规则。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>对于要添加到定义的每个处理，单击<b>[！UICONTROL添加项]</b>，然后输入或映射处理和大小。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
此操作模块允许您向 [!DNL split.io] API 发起自定义的已经过身份认证的调用。 通过这种方式，您可以构建其他 [!DNL split.io] 模块无法实现的数据流自动化。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>输入或映射模块在每次场景执行周期中可处理的最大记录数。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>对于要更新的拆分的每个属性，单击<b>[！UICONTROL添加项]</b>并输入或映射所需的更改。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[！UICONTROL Comments]</td> 
   <td>输入或映射要添加到拆分定义的任何注释。</td> 
