...
1. 输入电子邮件帐户的&#x200B;**[!UICONTROL User name]**&#x200B;和您的&#x200B;**[!UICONTROL Password]**。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>使用HTML标签以HTML格式或以纯文本输入或映射电子邮件内容。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Attachments]</p> </td> 
   <td> <p>对于要添加的每个附件，单击<b>添加项</b>并输入以下内容：</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL File name]</strong> </p> <p>输入文件名，包括扩展名。 </p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Email ID (UID)]</p> </td> 
   <td> <p>输入要删除的电子邮件的电子邮件UID 。</p> <p>您可以使用Email &gt; Watch Email模块或[!UICONTROL Search Email]模块获取电子邮件的UID。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Expunge]</td> 
   <td> <p>启用此选项可永久删除当前打开邮箱中标记为[!UICONTROL Deleted]的所有邮件。</p> <p>注意：在[!DNL Gmail]中，此行为由[!UICONTROL Settings] &gt;[!UICONTROL Forwarding POP/IMAP in IMAP access]部分中的设置驱动。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
此操作模块通过设置[!UICONTROL Read]标志将选定文件夹中的电子邮件或草稿标记为已读。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Email ID (UID)]</p> </td> 
   <td> <p>输入要标记为已读的电子邮件的电子邮件UID 。</p> <p>您可以使用Email &gt; Watch Email模块或[!UICONTROL Search Email]模块获取电子邮件的UID。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Email ID (UID)]</p> </td> 
   <td> <p>输入要标记为未读的电子邮件的Email UID。</p> <p>您可以使用Email &gt; Watch Email模块或[!UICONTROL Search Email]模块获取电子邮件的UID。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Email ID (UID)]</p> </td> 
   <td> <p>输入要移动到目标文件夹的电子邮件的Email UID。</p> <p>您可以使用Email &gt; Watch Email模块或[!UICONTROL Search Email]模块获取电子邮件的UID。</p> </td> 
  </tr> 
 </tbody> 
</table>
