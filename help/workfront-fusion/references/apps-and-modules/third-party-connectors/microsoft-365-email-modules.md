...
要使用 [!DNL Microsoft Office 365 Email] 模块，您必须拥有一个 [!DNL Microsoft Office 365 Email] 帐户。
...
在您配置 [!DNL Microsoft Office 365 Email] 模块时，Workfront Fusion 会显示以下字段。 除这些字段外，根据您的应用程序或服务访问权限级别，可能会显示更多 [!DNL Microsoft Office 365 Email] 字段。 模块中的加粗标题表示必填字段。
