...
>[!IMPORTANT]
>
>本文介绍了在2025年11月17日发布的新Slack连接器中可用的模块。
>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>输入要作为搜索依据的查询。 </p> <p>有关从映射面板创建公式的信息，请参阅<a href="/help/workfront-fusion/create-scenarios/map-data/map-using-functions.md" class="MCXref xref">在[!DNL Adobe Workfront Fusion]</a>中使用内置函数映射项。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL 限制] </td> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>选择要使用的webhook。</p> <p>或</p> <p>创建新的webhook。</p> 
    <ol> 
     <li value="1"> <p>点击<b>[!UICONTROL 添加]</b>。</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>输入或映射希望状态到期的日期和时间。 有关支持的日期和时间格式列表，请参阅<a href="/help/workfront-fusion/references/mapping-panel/data-types/type-coercion.md" class="MCXref xref" data-mc-variable-override="">类型强制转换</a>。</td> 
  </tr> 
 </tbody> 
</table>
