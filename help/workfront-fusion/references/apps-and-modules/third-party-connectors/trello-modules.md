...
## 将[!UICONTROL Trello]连接到Workfront Fusion

有关将[!UICONTROL Trello]帐户连接到Workfront Fusion的说明，请参阅[创建与Adobe Workfront Fusion的连接 — 基本说明](/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 输入Workfront Fusion在一个执行周期内返回的最大展示板数。 此值必须小于或等于1000。</p>  </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 输入或映射您希望Workfront Fusion在一个执行周期内返回的最大卡片数。 此值必须小于或等于1000。</p> </td> 
  </tr> 
  <tr> 
