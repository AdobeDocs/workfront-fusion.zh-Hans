...
配置[!UICONTROL Trello]模块时，[!DNL Workfront Fusion]显示下面列出的字段。 除此以外，可能还会显示其他[!UICONTROL Trello]字段，具体取决于应用程序或服务中的访问级别等因素。 模块中的粗体标题表示必填字段。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>选择一个选项，以指定可以在该讨论区投票的人员。 有关权限级别的投票限制，请参阅[!UICONTROL Permission level]字段。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Comments]</p> </td> 
   <td> <p>选择一个选项，以指定可以对此讨论区的信息卡进行评论的人员。 有关权限级别限制的注释，请参阅[!UICONTROL Permission level]字段。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>选择是否将默认列表集添加到讨论区([!UICONTROL To Do]、[!UICONTROL Doing]、[!UICONTROL Done])。</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>如果要为展示板启用卡盖，请选择<strong>[!UICONTROL Yes]</strong>。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>默认情况下，此模块会搜索成员内容，以查找与查询中每个单词完全匹配的内容。 启用[!UICONTROL Partial]后，模块将查找以查询中任意单词开头的内容。</p> <p> 例如，如果您使用“development”一词来查找标题为“My Development Status Report”（我的开发状态报告）的展示板，则默认情况下需要搜索整个词。 如果您启用了[!UICONTROL Partial]，则可以搜索“dev”，但不能搜索“velopment”。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 输入信息卡的到期日期。 有关支持的日期和时间格式的列表，请参阅<a href="/help/workfront-fusion/references/mapping-panel/data-types/type-coercion.md" class="MCXref xref">在[!DNL Adobe Workfront Fusion]</a>中键入强制。</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 选择您要如何输入要编辑的卡片ID。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在<strong>[!UICONTROL Card ID]</strong>字段中，输入或映射要编辑的信息卡ID。<br></p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 选择您要如何输入用于检索其详细信息的卡的ID。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在<strong>[!UICONTROL Card ID]</strong>字段中，输入或映射要检索其详细信息的卡的ID。<br></p> </li> 
  ...
  <tr> 
   ...
   <td> <p>输入搜索查询。 您可以使用以下搜索运算符来优化搜索：</p> 
    <ul> 
     ...
     <li><code><strong>board:id</strong></code> <p>返回特定展示板中的卡片。 例如，<code>board:Trello</code>将在展示板名称中包含[!UICONTROL Trello]的展示板上返回卡片。</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>选择您希望如何输入卡片ID和成员ID。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>输入或映射<strong>[!UICONTROL Card ID]</strong>和<strong>[!UICONTROL Member ID]</strong>。</p> </li> 
...
此操作模块可检索有关[!UICONTROL Trello]成员的信息。
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 选择您要如何输入要添加核对清单的卡的ID。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在<strong>[!UICONTROL Card ID]</strong>字段中，输入或映射要添加清单的卡ID。<br></p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 选择您要如何输入卡的ID以及要在其中编辑项目的核对清单。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在<strong>[!UICONTROL Checklist ID]</strong>字段中，输入或映射要添加清单的卡ID。</p> <p>在<strong>[!UICONTROL Checklist Item ID]</strong>字段中，输入或映射清单的ID。</p> </li> 
     <li> <p><strong>[!UICONTROL Select]</strong> </p> <p>选择包含要在其中添加清单的卡的主板，然后选择包含该卡的列表，然后选择清单。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 选择您要如何输入要添加核对清单的卡的ID。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在<strong>[!UICONTROL Card ID]</strong>字段中，输入或映射要添加清单的卡ID。 在<strong>[!UICONTROL Label ID]</strong>字段中，输入或映射要添加标签的标识。<br></p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 选择您希望如何输入要添加注释的卡片ID。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在<strong>[!UICONTROL Card ID]</strong>字段中，输入或映射要添加注释的卡ID。<br></p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>设置创建评论时段的开始日期。 有关支持的日期和时间格式的列表，请参阅<a href="/help/workfront-fusion/references/mapping-panel/data-types/type-coercion.md" class="MCXref xref">在[!DNL Adobe Workfront Fusion]</a>中键入强制。</p> </td> 
  </tr> 
  <tr> 
