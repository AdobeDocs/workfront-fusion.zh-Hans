...
* 必须先在[!DNL Anaplan]Anaplan[!UICONTROL 帐户中配置工作区、模型和其他]对象，Workfront Fusion才能与这些对象交互。
  ...
  <tr> 
   ...
   <td> <p>选择要读取的记录类型。</p> 
    <ul> 
     ...
     <li> <p><b>工作区</b> </p> <p>选择或映射您要读取的Workspace的ID。</p> </li> 
     <li> <p><b>查看</b> </p> <p>选择或映射包含要读取的视图的模型ID。</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
