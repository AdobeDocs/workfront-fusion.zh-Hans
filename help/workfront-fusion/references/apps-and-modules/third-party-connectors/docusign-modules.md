...
要使用 [!DNL DocuSign] 模块，您必须拥有一个 [!DNL DocuSign] 帐户。
...
## 将 [!DNL DocuSign] 连接到 Workfront Fusion {#connect-docusign-to-workfront-fusion}
...
在您配置 [!DNL DocuSign] 模块时，Workfront Fusion 会显示以下字段。 除这些字段外，根据您的应用程序或服务访问权限级别，可能会显示更多 [!DNL DocuSign] 字段。 模块中的加粗标题表示必填字段。
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">[!UICONTROL 连接]</td> 
   <td> <p>有关将 [!DNL DocuSign] 帐户连接到 Workfront Fusion 的说明，请参阅本文中的<a href="#connect-docusign-to-workfront-fusion" class="MCXref xref">将 [!DNL DocuSign] 连接到 Workfront Fusion</a>。</p> </td>
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL 帐户] </td> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   <td>[!UICONTROL 标头]</td> 
   <td> <p>以标准 JSON 对象的形式添加请求标头。 这将决定请求的内容类型。</p> <p>例如，<code> {"Content-type":"application/json"}</code></p> <p>注意：如果出现错误且难以确定来源，请根据 Workfront 文档修改请求标头。 如果自定义API调用返回422 HTTP请求错误，请尝试使用“Content-Type”：“text/plain”标头。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL 文档 ID]</p> </td> 
