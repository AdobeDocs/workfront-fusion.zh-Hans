...
在 Adobe Workfront Fusion 场景中，您可以自动化使用 [!DNL Jira Software] 的工作流，并将其连接到多个第三方应用程序和服务。
...
## 将 [!DNL Jira Software] 连接到 Workfront Fusion
...
### 将 [!DNL Jira Cloud] 连接到 Workfront Fusion
...
### 将 [!DNL Jira Server] 连接到 Workfront Fusion
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL ID或密钥]</td> 
   <td>输入或映射要更新的记录的ID或键，然后填写特定于此记录类型的其他字段即会显示在模块中。</td> 
  </tr> 
 </tbody> 
</table>
