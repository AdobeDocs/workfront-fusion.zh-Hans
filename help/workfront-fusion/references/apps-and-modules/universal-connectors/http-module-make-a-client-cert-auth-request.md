...
配置[!UICONTROL HTTP] > [!UICONTROL 发出客户端证书授权请求]模块时，Adobe Workfront Fusion显示以下列出的字段。 模块中的加粗标题表示必填字段。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>选择包含您的客户端证书身份验证凭据的密钥，或单击<strong>[！UICONTROL添加]</strong>将您的凭据添加到新密钥。 </p> <p>注意：您可以添加更多凭据以便轻松地在每个连接之间切换。</p>           <p>要提取您的私钥或证书：</p>
          <ol>
            <li value="1">
