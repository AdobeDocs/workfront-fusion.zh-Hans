...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>有关建立与FTP帐户的连接的说明，请参阅本文中的FTP模块<a href="#create-a-connection" class="MCXref xref">中的</a>[！UICONTROL创建连接]。</p> </td> 
  </tr> 
  <tr> 
...
<table>
   ...
   <tbody>
         <tr>
            <td>[！UICONTROL Connection]</td>
            <td>有关建立与FTP帐户的连接的说明，请参阅本文中的FTP模块<a href="#Create" class="MCXref xref" >中的</a>[！UICONTROL创建连接]。</td>
         </tr>
         <tr>
