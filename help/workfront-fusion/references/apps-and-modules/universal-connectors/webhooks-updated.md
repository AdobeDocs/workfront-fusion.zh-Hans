...
有关mTLS的详细信息，请参阅在HTTP模块中使用mTLS一文中的[双向TLS概述](/help/workfront-fusion/references/apps-and-modules/universal-connectors/use-mtls-in-http-modules.md#mutual-tls-overview)。
...
1. 在&#x200B;**授权类型**&#x200B;字段中，选择&#x200B;**[!UICONTROL 客户端证书]**。
1. 在&#x200B;**凭据**&#x200B;字段中，选择要用于授权的凭据，或添加新凭据。
1. （视情况而定）要添加凭据：
   1. 单击&#x200B;**添加**
   1. 输入新凭据密钥的名称
   1. 在&#x200B;**证书**&#x200B;字段中，粘贴您的证书。
   1. 在&#x200B;**私钥**&#x200B;字段中，粘贴您的私钥。
      ...
      >[!TIP]
      >
      >如果需要从组合文件中提取证书或私钥，请单击该字段旁边的&#x200B;**提取**，选择您要提取的内容，并提供文件和密码。
   1. 单击&#x200B;**创建键**。
