...
1. 填写以下字段：
   ...
   <table style="table-layout:auto"> 
      ...
      <tbody>
        ...
        <tr>
          <td role="rowheader">[！UICONTROL Meta范围]（仅限JWT）</td>
          <td>
            输入连接所需的任何元范围。
          </td>
        </tr>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>如果您的HTML引用JavaScript变量，则可以在此处包含这些变量。 </p> <p>对于每个变量，单击<strong>[！UICONTROL添加项]</strong>并包含该变量的键和值。</p> <p>注释：   
     <ul> 
...
* [使用[!UICONTROL 模板生成]文档 [!DNL Microsoft Word] 模块](#use-the-generate-document-module-with-a-microsoft-word-template)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>选择要对文件执行的操作。</p> 
    <ul> 
     <li> <p><b>[！UICONTROL删除]</b> </p> <p>选择此选项可从文档中删除页面。</p><p>对于每个要删除的页面范围，单击<strong>[！UICONTROL添加]</strong>，然后输入页面范围的首页和最后一页。 </p> <p>注释：   
     <ul> 
