...
在您配置 [!DNL Adobe Photoshop] 模块时，Workfront Fusion 会显示以下字段。 除这些字段外，根据您的应用程序或服务访问权限级别，可能会显示更多 [!DNL Adobe Photoshop] 字段。 模块中的加粗标题表示必填字段。
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    <tr>
      <td role="rowheader">[!UICONTROL 十六进制]</td>
...
此模块支持大文件。 有关大文件的详细信息，请参阅[使用大文件](/help/workfront-fusion/references/scenarios/fusion-large-files.md)。
