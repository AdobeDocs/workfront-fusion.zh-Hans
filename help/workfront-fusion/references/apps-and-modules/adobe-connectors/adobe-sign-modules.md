...
description: 使用 [!DNL Adobe Acrobat Sign] 模块，您可以基于 [!DNL Adobe Workfront Fusion] Acrobat Sign帐户中的事件启动 [!DNL Adobe] 方案，创建、读取或更新协议和其他记录，使用您设置的条件搜索记录以及上传文档。
author: Becky
...
通过[!DNL Adobe Acrobat Sign]模块，您可以基于[!DNL Adobe Workfront Fusion]帐户中的事件启动[!DNL Adobe Acrobat Sign]方案，创建、读取或更新协议和其他记录，使用您设置的条件搜索记录以及上传文档。
