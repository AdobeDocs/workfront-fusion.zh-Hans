...
title: Fusion 应用程序及其模块参考：文章索引
description: 本节包含与配置 Adobe Workfront Fusion 中特定模块相关的参考资料。
author: Becky
...
这些连接器可用于连接任何具有公共 API 的应用程序或 Web 服务。

* [http > [!UICONTROL 发起请求]模块](/help/workfront-fusion/references/apps-and-modules/universal-connectors/http-module-make-a-request.md)
...
* [Adobe Content Tagger模块](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/content-tagging-modules.md)
...
* [Adobe Experience Manager MCP模块](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/aem-mcp-modules.md)
* [Adobe Express模块](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/adobe-express-modules.md)
...
* [Adobe Firefly Lightroom模块](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/adobe-firefly-lightroom.md)
...
* [Adobe Workfront MCP模块](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/workfront-mcp-modules.md)
...
这些模块允许您对数据执行操作，无需连接到 Fusion 以外的任何服务。
