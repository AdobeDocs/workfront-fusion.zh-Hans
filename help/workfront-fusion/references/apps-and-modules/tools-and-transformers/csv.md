...
有关更多信息，请参阅[项目数据类型](/help/workfront-fusion/references/mapping-panel/data-types/item-data-types.md)。
...
1. 单击[!UICONTROL 数据结构]字段旁边的<strong>[!UICONTROL 添加]</strong>按钮以创建新的数据结构。
