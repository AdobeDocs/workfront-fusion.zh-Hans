...
1. 将数据结构的名称更改为更具体的名称，然后单击&#x200B;**[!UICONTROL Save]**。
...
1. 创建新方案。
1. 添加[!UICONTROL HTTP] > [!UICONTROL Get a file]模块
