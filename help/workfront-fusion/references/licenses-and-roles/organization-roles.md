...
本文介绍Workfront Fusion中针对不同团队和组织角色提供的访问和功能。

>[!NOTE]
>
>在Workfront Fusion中，组织角色与团队角色是分开的。 有关组织和团队角色的更多信息，请参阅[组织和团队概述](/help/workfront-fusion/set-up-and-manage-workfront-fusion/set-up-and-manage-orgs-and-teams/set-up-orgs-teams-and-users/org-and-team-overview.md)。
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p>管理组织用户</p> </td> 
   <td>✓ </td> 
   <td>✓<p>如果组织使用Adobe Admin Console，则可以在Adobe IMS上管理用户。 只能邀请用户加入其他组织。</td> 
   <td> </td> 
   <td> </td> 
  </tr> 
  <tr> 
